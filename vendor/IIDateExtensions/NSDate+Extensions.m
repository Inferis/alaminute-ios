...
+ (NSDate*)II_dateWithDay:(int)day month:(int)month year:(int)year {
    return [NSDate II_dateFromString:[NSString stringWithFormat:@"%04d%02d%02d", year, month, day] withFormat:@"yyyyMMdd"];
}

#ifndef II_CLEAN_NAMESPACE
+ (NSDate*)dateWithDay:(int)day month:(int)month year:(int)year {
    return [NSDate II_dateWithDay:day month:month year:year];
}
#endif
